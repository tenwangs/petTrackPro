...
const support = () => {
    return ( 
        ...
        <div className="flex flex-row mt-8 ">
             <div className="w-60 h-60 bg-white mt-8 ml-60 border border-gray-200 rounded-xl text-4xl">
            
            <p className="font-bold ml-6 text-l text-xl text-[#282835]">Help & Self Guide</p>
            <p className="text-sm text-gray-600 mt-2 ml-6">Find answers to all your <br></br> questions about Pet-track pro</p>
        </div>

         <div className="w-60 h-60 bg-white mt-8 ml-60 rounded-xl border border-gray-200">
            <p className="font-bold text-l ml-6 text-xl text-[#282835]">Email</p>
            <p className="text-sm text-gray-600 mt-2 ml-6">tenzinwangs777@gmail.com</p>
        </div>

         <div className="w-60 h-60 bg-white mt-8 ml-60 text-xl rounded-xl border border-gray-200">
            <p className="font-bold text-l ml-8 text-[#282835]">Location</p>
            <p className="text-sm text-gray-600 mt-2 ml-8">Cst -Rinchending, p/ling</p>
        </div>
