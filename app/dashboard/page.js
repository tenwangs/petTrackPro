...
function page() {
  ...
  return (
    <div>
      <div>
        <h1 className='text-3xl font-bold text-[#5A92B1] mt-12 ml-8'>
          Activity
        </h1>
      </div>
          ...
          <div className='flex flex-row'>
            <div className='flex flex-row'>
              <div className='w-8 h-8 bg-[#87CEEB] ml-12 mt-24'>
                <div>
                  <p className='ml-10 text-gray-800 font-bold mt-1'> Cold</p>
                </div>
              </div>
            </div>
            ...
            <div className='w-8 h-8 bg-[#28ed05] ml-20 mt-24'>
              <div>
                <p className='ml-10 text-gray-800 font-bold mt-1'> Normal </p>
              </div>
            </div>

            <div className='w-8 h-8 bg-[#ed0505] ml-20 mt-24'>
              <div>
                <p className='ml-10 text-gray-800 font-bold mt-1'> Hot</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className='bg-[#EBF5FC]  h-40 mt-2'>
            <div className=''>
              <Circle
                ...
                strokeWidth={6}
                strokeColor='#02bf34 '
                className='ml-4 pl-10 w-28 h-28'
              />
